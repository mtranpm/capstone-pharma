...
Defines source, audit, blinding, missing-data and correction principles.

## Mandatory controls

- Preserve source, audit trail, blinding and correction history.
- Flag unusual patterns without declaring misconduct.
- Do not overwrite missing or conflicting data.
