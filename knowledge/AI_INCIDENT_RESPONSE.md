...
Defines containment, evidence preservation, rollback and regulatory assessment.

## Mandatory controls

- Contain affected models, prompts, retrieval sources, tools and credentials.
- Preserve logs, versions, evidence hashes and decision impact.
- Assess rollback, notification, CAPA, revalidation and safe resumption.
