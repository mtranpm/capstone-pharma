...
Defines portability, evidence export, substitution and retirement obligations.

## Mandatory controls

- Define data, model, prompt, embedding, evaluation, log and tool export requirements.
- Test substitution and evidence readability before exit.
- Retain records for the required period and document destruction.
