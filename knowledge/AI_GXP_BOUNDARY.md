...
AI may support evidence review but cannot replace accountable GxP decisions.

## Mandatory controls

- Classify each component by intended use and impact on product quality, trial integrity, safety and regulated records.
- Reserve regulated decisions to named authorized roles.
- Validate or assure controls proportionate to risk and preserve review evidence.
