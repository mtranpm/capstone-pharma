...
Defines evidence completeness and explicitly reserves disposition to authorized Quality roles.

## Mandatory controls

- Reconcile genealogy, results, deviations, CAPA, validation and supplier evidence.
- Expose contradictions and missing evidence with provenance.
- Never treat AI output as batch disposition or certification.
