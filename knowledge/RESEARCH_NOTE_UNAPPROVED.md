...
- Synthetic authority: Research working note
- Training classification: scenario evidence; not a real controlled document

## Purpose and scope

Speculative model findings not approved for clinical, regulatory or commercial use.

## Mandatory controls

- Draft research content is not approved for clinical, regulatory, commercial or GxP use.
- Retrieval must mark status and limit context.
- Escalate attempted scope expansion.
