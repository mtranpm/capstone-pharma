...
Requires language-qualified review and subgroup performance evidence.

## Mandatory controls

- Retain original language and translated text with provenance.
- Use language-qualified review for material uncertainty.
- Evaluate performance by language and subgroup.
