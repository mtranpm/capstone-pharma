...
Defines duplicate review evidence and prohibits irreversible automated merge.

## Mandatory controls

- Generate candidates with reasons and uncertainty.
- Never irreversibly merge or delete cases automatically.
- Preserve source-specific receipt and follow-up history.
